 ...
 *
 * @property {string} [giveaway='@everyone\n\n🎉🎉 **CONCOURS** 🎉🎉'] Displayed above the giveaway embed when the giveaway is running.
 * @property {string} [giveawayEnded='@everyone\n\n🎉🎉 **CONCOURS FINI** 🎉🎉'] Displayed above the giveaway embed when the giveaway is ended.
 * @property {string} [inviteToParticipate='Cochez la réaction 🎉 pour participer !'] Displayed in the giveaway embed. Incite people to react to the giveaway.
 * @property {string} [timeRemaining='Temps restant : **{duration}** !'] Displayed below inviteToParticipate in the giveaway embed. {duration} will be replaced automatically with the time remaining.
 * @property {string} [winMessage='Félicitations, {winners}! Vous avez gagné(e) **{prize}** !'] Sent in the channel when the giveaway is ended.
 * @property {string} [embedFooter='Propulsé par le paquet (module) discord-giveaways crée par Androz2091'] The footer of the giveaway embed.
 * @property {string} [noWinner='Concours fini, dû à aucune participation valide.'] Sent in the channel if there's no valid winner for the giveaway.
 * @property {string} [winners='gagnant(e)(s)'] Displayed next to the embed footer, used to display the number of winners of the giveaways.
 * @property {string} [endedAt='Fin/fini à :'] Displayed next to the embed footer, used to display the giveaway end date.
 * @property {string} [hostedBy='Hébergé par : {user}'] Below the inviteToParticipate message, in the description of the embed.
 * @property {Object} [units]
 * @property {string} [units.seconds='secondes'] The name of the 'seconds' units
 * @property {string} [units.minutes='minutes'] The name of the 'minutes' units
 * @property {string} [units.hours='heures'] The name of the 'hours' units
 * @property {string} [units.days='jour(s)'] The name of the 'days' units
...
exports.defaultGiveawayMessages = {
    ...
    inviteToParticipate: 'Cochez la réaction 🎉 pour participer !',
    timeRemaining: 'Temps restant : **{duration}** !',
    winMessage: 'Félicitations, {winners}! Vous avez gagné(e) **{prize}** !',
    embedFooter: 'Propulsé par le paquet (module) discord-giveaways crée par Androz2091',
    noWinner: 'Concours fini, dû à aucune participation valide.',
    winners: 'gagnant(e)(s)',
    endedAt: 'Fin/fini à :',
 ...
 * @property {string} [messages.congrat=':tada: Nouveau(x) gagnant(s)/Nouvelle(s) gagnante(s) : {winners} ! Félicitations !'] The message used if there are winners
 * @property {string} [messages.error='Aucune participation n'est valide, donc aucun(e)(s) gagnant(e)(s) ne peut/peuvent être choisi(e)(s) !'] The message used if no winner can be choosen
 */
...
exports.defaultRerollOptions = {
    winnerCount: null,
    messages: {
        congrat: ':tada: Nouveau(x) gagnant(s)/Nouvelle(s) gagnante(s) : {winners} ! Félicitations !',
        error: 'Aucune participation n\'est valide, donc aucun(e)(s) gagnant(e)(s) ne peut/peuvent être choisi(e)(s) !'
    }
};
